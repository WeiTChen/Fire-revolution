...
#define FTDefaultTintColor          [UIColor colorWithRed:127/255.f green:172/255.f blue:255/255.f alpha:1.f]
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier menuName:(NSString *)menuName iconImageName:(NSString *)iconImageName textColor:(UIColor *)textColor textAlignment:(NSTextAlignment)textAlignment
{
    ...
    if (self) {
        ...
        CGRect iconImageRect = CGRectMake(margin * 1.5, margin, FTDefaultMenuIconWidth, FTDefaultMenuIconWidth);
        ...
        if (iconImage) {
            ...
            menuNameRect = CGRectMake(margin, margin, FTDefaultMenuWidth + (margin * 0.5), FTDefaultMenuIconWidth);
        }else{
        ...
        _menuNameLabel.textAlignment = textAlignment;
...
//        _menuTableView.separatorColor = SPEARATER_COLOR;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_menuIconNameArray.count >= indexPath.row + 1) {
...
{
    [[self sharedInstance] showForSender:sender senderFrame:CGRectNull withMenu:menuArray imageNameArray:nil textAlignment:NSTextAlignmentLeft doneBlock:doneBlock dismissBlock:dismissBlock];
}
+ (void) showForSender:(UIView *)sender
              withMenu:(NSArray<NSString*> *)menuArray
        imageNameArray:(NSArray<NSString*> *)imageNameArray
          ...
          dismissBlock:(FTPopOverMenuDismissBlock)dismissBlock;
{
    [[self sharedInstance] showForSender:sender senderFrame:CGRectNull withMenu:menuArray imageNameArray:imageNameArray textAlignment:NSTextAlignmentLeft doneBlock:doneBlock dismissBlock:dismissBlock];
}
...
+ (void) showFromEvent:(UIEvent *)event
          ...
          dismissBlock:(FTPopOverMenuDismissBlock)dismissBlock
{
    [[self sharedInstance] showForSender:[event.allTouches.anyObject view] senderFrame:CGRectNull withMenu:menuArray imageNameArray:nil textAlignment:NSTextAlignmentLeft doneBlock:doneBlock dismissBlock:dismissBlock];
}
...
+ (void) showFromEvent:(UIEvent *)event
        ...
        textAlignment:(NSTextAlignment)textAlignment
          ...
          dismissBlock:(FTPopOverMenuDismissBlock)dismissBlock
{
    [[self sharedInstance] showForSender:[event.allTouches.anyObject view] senderFrame:CGRectNull withMenu:menuArray imageNameArray:imageNameArray textAlignment:textAlignment doneBlock:doneBlock dismissBlock:dismissBlock];
...
+ (void) showFromSenderFrame:(CGRect )senderFrame
               ...
               dismissBlock:(FTPopOverMenuDismissBlock)dismissBlock
{
    [[self sharedInstance] showForSender:nil senderFrame:senderFrame withMenu:menuArray imageNameArray:nil textAlignment:NSTextAlignmentLeft doneBlock:doneBlock dismissBlock:dismissBlock];
}
+ (void) showFromSenderFrame:(CGRect )senderFrame
                    withMenu:(NSArray<NSString*> *)menuArray
              imageNameArray:(NSArray<NSString*> *)imageNameArray
                ...
                dismissBlock:(FTPopOverMenuDismissBlock)dismissBlock
{
    [[self sharedInstance] showForSender:nil senderFrame:senderFrame withMenu:menuArray imageNameArray:imageNameArray textAlignment:NSTextAlignmentLeft doneBlock:doneBlock dismissBlock:dismissBlock];
}
...
-(void)adjustPopOverMenu
{
    ...
    if (menuArrowPoint.x + self.preferedWidth/2 + FTDefaultMargin > KSCREEN_WIDTH) {
        ...
        menuX = senderRect.origin.x + (senderRect.size.width)/2 - self.preferedWidth/2 + 18;
    }
